...
// Transcribed from Waveshare's official ESP32-S3-Touch-LCD-1.85C demo
// (Arduino/examples/01_lvgl_example/Display_ST77916.cpp,
// vendor_specific_init_new[], the "case 2" panel variant table) into
// GFX Library for Arduino's batchOperation opcode format. Register
// addresses/values are unchanged from the vendor source; COLMOD, SLPOUT
// and DISPON are appended since GFX Library expects those explicitly.
static const uint8_t st77916_r48_init_operations[] = {
    BEGIN_WRITE,
    ...
    WRITE_C8_D8, 0x3A, 0x55, // COLMOD: 16-bit/pixel (RGB565)
    WRITE_C8_D8, 0x11, 0x00, // SLPOUT
    END_WRITE,
    DELAY, ST77916_SLPOUT_DELAY,
    BEGIN_WRITE,
    WRITE_C8_D8, 0x29, 0x00, // DISPON
    END_WRITE};

Arduino_ST77916_R48::Arduino_ST77916_R48(
    Arduino_DataBus *bus, int8_t rst, uint8_t r,
    bool ips, int16_t w, int16_t h)
    : Arduino_ST77916(bus, rst, r, ips, w, h) {
}

void Arduino_ST77916_R48::tftInit() {
  ...
  _bus->batchOperation(st77916_r48_init_operations, sizeof(st77916_r48_init_operations));
