...
constexpr ThemeProfile THEME_PROFILES[] = {
    ...
    {"halloween", "Ghouls & Goblins", "spooky",
    ...
    {"thanksgiving", "Turkey Trot", "harvest",
    ...
    {"new_years", "Countdown", "celebration",
