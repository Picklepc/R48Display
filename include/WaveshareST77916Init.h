...
// Waveshare ESP32-S3-Touch-LCD-1.85 ST77916 vendor init sequence.
// Derived from the Waveshare LVGL_Arduino demo's vendor_specific_init_new table.
static const uint8_t waveshare_st77916_init_operations[] = {
    BEGIN_WRITE,
