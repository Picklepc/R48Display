...
| Version | Summary |
|---|---|
| [v0.5.0a12](docs/releases/v0.5.0a12.md) | **Alpha (pre-release)** — moves NimBLE work into a dedicated BLE worker task, makes settings-page BLE scan async/polled, and adds BLE worker diagnostics for 3.x coexistence testing. |
